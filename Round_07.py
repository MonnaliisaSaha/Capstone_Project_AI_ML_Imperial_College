"""
Round 7 — Full GP + UCB + SVM + NN Pipeline
================================================
Systematic hyperparameter tuning. Three all-time bests.
...
FUNCTION_CONFIG = {
    ...
    2: {"beta": 2.0, "step": 0.005},
    3: {"beta": 2.5, "step": 0.020},
    4: {"beta": 1.5, "step": 0.015},
    5: {"beta": 0.8, "step": 0.030},
    6: {"beta": 3.0, "step": 0.050},
    7: {"beta": 1.0, "step": 0.020},
...
if __name__ == "__main__":
    import sys
    print("=" * 60)
    print(f"BBO Round 7 — Full Pipeline")
