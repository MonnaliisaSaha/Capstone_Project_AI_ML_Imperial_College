...
FUNCTION_CONFIG = {
    ...
    1: {"beta": 3.0, "step": 0.010},
    2: {"beta": 2.0, "step": 0.003},
    3: {"beta": 2.0, "step": 0.010},
    4: {"beta": 1.5, "step": 0.010},
    5: {"beta": 0.8, "step": 0.030},
    6: {"beta": 2.5, "step": 0.030},
    7: {"beta": 1.0, "step": 0.010},
    8: {"beta": 0.5, "step": 0.005},
}
...
if __name__ == "__main__":
    import sys
    print("=" * 60)
    print(f"BBO Round 11 — Full Pipeline")
