"""
Round 8 — Full GP + UCB + SVM + NN Pipeline
================================================
Recovery round. F4 returned to R7 coordinates.
...
FUNCTION_CONFIG = {
    ...
    3: {"beta": 2.5, "step": 0.018},
    4: {"beta": 1.5, "step": 0.015},
    5: {"beta": 0.8, "step": 0.030},
    6: {"beta": 3.0, "step": 0.040},
...
if __name__ == "__main__":
    import sys
    print("=" * 60)
    print(f"BBO Round 8 — Full Pipeline")
