"""
Round 4 — Full GP + UCB + SVM + NN Pipeline
================================================
NN gradient analysis added. Full pipeline operational.
...
FUNCTION_CONFIG = {
    ...
    1: {"beta": 3.0, "step": 0.030},
    2: {"beta": 2.0, "step": 0.030},
    3: {"beta": 2.5, "step": 0.030},
    4: {"beta": 2.0, "step": 0.030},
    5: {"beta": 1.5, "step": 0.030},
    6: {"beta": 3.0, "step": 0.030},
    7: {"beta": 1.5, "step": 0.030},
    8: {"beta": 1.0, "step": 0.030},
}
...
if __name__ == "__main__":
    import sys
    print("=" * 60)
    print(f"BBO Round 4 — Full Pipeline")
