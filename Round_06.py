"""
Round 6 — Full GP + UCB + SVM + NN Pipeline
================================================
Best round. Return-to-best logic. Six functions improved.
...
FUNCTION_CONFIG = {
    ...
    2: {"beta": 1.5, "step": 0.008},
    3: {"beta": 2.0, "step": 0.020},
    4: {"beta": 1.5, "step": 0.012},
    5: {"beta": 0.8, "step": 0.030},
    6: {"beta": 3.0, "step": 0.050},
    7: {"beta": 1.0, "step": 0.018},
    8: {"beta": 0.5, "step": 0.010},
}
...
if __name__ == "__main__":
    import sys
    print("=" * 60)
    print(f"BBO Round 6 — Full Pipeline")
